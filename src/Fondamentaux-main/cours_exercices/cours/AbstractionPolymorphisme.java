...
class Voiture extends Vehicule{
    ...
    @Override
    public void rouler(){
        System.out.println("la voiture roule, type : "+super.type);
    }
}
...
class Camion extends Vehicule{
    ...
    @Override
    public void rouler(){
        System.out.println("Le camion roule, type : "+ super.type);
    }
}
...
public class AbstractionPolymorphisme {
    public static void main(String[] args) {	
        //type véhicule, définie comme une voiture ou un camion.
